...
INVITATION_TEMPLATE = {
    ...
    'body': (
        ...
        'the assessment.\n\n'
        '- Please keep your physical Aadhaar Card ready and within reach - you will be asked to '
        'photograph it as part of identity verification, and the assessment cannot start until '
        'it is successfully verified. Show the front side, with your Aadhaar number and date of '
        'birth both clearly visible and no glare. If it is not read correctly, you can retake the '
        'photo as many times as needed.\n\n'
