...
INVITATION_TEMPLATE = {
    ...
    'body': (
        ...
        'the assessment.\n\n'
        '- Please keep your Aadhaar Card ready and within reach - you will be asked to '
        'photograph it as part of identity verification, and the assessment cannot start until '
        'it is successfully verified. Show the front side, with the Aadhaar number and your date '
