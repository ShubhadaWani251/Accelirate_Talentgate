        ...
        <div className="auth-card" style={{ maxWidth: 480 }}>
          ...
          <div className="card">
            ...
            <ul style={{ fontSize: 12.5, margin: 0, paddingLeft: 18, lineHeight: 1.8 }}>
              ...
              <li>You're now in full-screen mode for the rest of this assessment — exiting it once the exam begins ends your attempt automatically</li>
              <li>Do not switch browser tabs, open other applications, or use keyboard shortcuts like Print Screen, F12, or Ctrl+U once the exam begins</li>
              <li>Doing so will end your attempt automatically and be logged, with the specific reason shown to you</li>
