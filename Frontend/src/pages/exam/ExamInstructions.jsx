        ...
        <div className="auth-card" style={{ maxWidth: 480 }}>
          ...
          <div className="card">
            ...
            <ol style={{ fontSize: 12.5, margin: 0, paddingLeft: 20, lineHeight: 1.8 }}>
              <li>Please keep your physical Aadhaar Card ready and within reach before proceeding — you'll be asked to photograph it, and if it can't be read automatically the first time, you'll get one more chance to retake it</li>
